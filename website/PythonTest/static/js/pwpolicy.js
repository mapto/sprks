...
jQuery(document).ready(function () {
    ...
    console.log('FOUND error psets=0')

    /*preset pswd dictionary value*/
    if ($:
    pdict == jQuery("#dic").val()
    )
    {
    ...
    if ($:
    pautorecover == jQuery("#autorecover").val()
    )
    {
